    ...
    return (
        <>
            ...
            <div class="container py-4">
                ...
                <h2 class="h4 mb-2">1. Information We Collect</h2>
                <p class="mb-4">
                ...
                <h2 class="h4 mb-2">2. How We Use Your Information</h2>
                <p class="mb-4">
                ...
                <h2 class="h4 mb-2">3. Sharing Your Information</h2>
                <p class="mb-4">
                ...
                <h2 class="h4 mb-2">4. Security Measures</h2>
                <p class="mb-4">
                    We implement a variety of security measures to maintain the safety of your personal information when you place an order or enter, submit, or access your personal information.
                </p>
                <h2 class="h4 mb-2">5. Your Rights</h2>
                <p class="mb-4">
